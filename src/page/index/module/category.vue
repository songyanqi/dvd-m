<template>
    <div class="good_list_con">
        <div class="good_list_2_row">
            <!--单个商品模版template-->
            <a v-for="(item, idx) in list" :data-id="item.goods_id" :href="a_href(item.goods_id)" :key='idx' :data-growing-idx='idx' :data-growing-title='item.goods_name'
                     class="good_item">
                    <div class="good_img_container">
                        <div class="img_container">
                            <img v-lazy="item.goods_img" style="display: inline;">
            ...
            <div v-show = "loading" class="no_more">
                商品加载中 <img v-lazy="'//9i.dvmama.com/free/loading_03252.svg'">
            </div>
