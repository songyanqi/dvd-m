<template>
  <div class="assistance_box" v-if="response && goodsdata">
    ...
    <div v-if="response.type == '0'" class="title_img">
      <img style="width:1.8rem;" src="//9i.dvmama.com/free/20170915_assistance/huhaoyou2.png">
      <div class="dtime" v-if="response.actType == 0">
        距助力结束：{{goodsdata.goods.overTime | formatRemainTime}}
      </div>
      <div class="qiqiu_ing">
        <img src="//9i.dvmama.com/free/20170915_assistance/qiqiu.png">
        <img src="//9i.dvmama.com/free/20170915_assistance/bangbangtang.png">
      </div>
    </div>
    <!--助好友0元购-->
    <div v-if="response.type == '1'" class="title_img">
      <img style="width: 2.57rem;" src="//9i.dvmama.com/free/20170915_assistance/zhuhaoyou.png">
      ...
      <div class="qiqiu_ing">
        <img class="qiqiua" src="//9i.dvmama.com/free/20170915_assistance/qiqiu.png">
      </div>
    </div>
    ...
    <div class="rule_brand">
      <img @click="rule_form = true" title="0987654" src="//9i.dvmama.com/free/20170915_assistance/rule.png">
      <img src="//9i.dvmama.com/free/20170915_assistance/bear.png">
      <!--助力者页面按钮信息-->
    ...
    <img class="table_brand" src="//9i.dvmama.com/free/20170915_assistance/table_brand.png">
    <!--助力结束和助力发起页不显示这个-->
...
//  import {Swiper, SwiperItem} from 'vux'
  ...
  export default {
    ...
    components: {
      Swiper,
      SwiperItem,
      'com-scratch-card': require('../../../component/com-scratch-card.vue').default
    },
    computed: {},
    watch: {
      // 监听response变化
    ...
    methods: {
      ...
      getData() {
        ...
        $.ajax({
          ...
          type: 'post',
          dataType: 'json',
          data: encrypt.ajax({goodsId: ts.goodsId, shareUserId: ts.shareUserId}),
          success(response) {
      ...
      assistance: function () {
        ...
        if (login.isSeller()) {
          $.ajax({
            ...
            type: 'post',
            dataType: 'json',
            data: encrypt.ajax({goodsId: that.goodsId, shareUserId: that.shareUserId}),
            success(response) {
...
<style lang="sass" lang="scss" rel="stylesheet/scss">
  ...
  .awd_touch {
    background-image: url("//9i.dvmama.com/free/20170915_assistance/awbg.png");
    width: 3.35rem;
    height: 0.76rem;
    margin: 0 auto;
    background-size: 100%;
