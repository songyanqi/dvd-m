<template>
  <div class="container">
    ...
    <!--<div class="header" v-if='!isapp'>-->
      ...
      <!--<div v-show="!flag">-->
        <!--<div class="title">-->
          ...
          <!--</div>-->
          <!--<div class="text">-->
            <!--<div class="left_text" @click="fn">全部笔记</div>-->
    ...
    <!--v-if="!ua.isDvdApp()"-->
    <!--<com-top-title home :style="{display: ua.isDvdApp() ? 'none' : null}">-->
    <com-top-title back home v-if="ua.isDvdApp() === false">
      <div class="text" slot="center">
        <div class="left_text" :class="{color_pink: flag}" @click="fn(true);">全部笔记
          <div class="red_line" v-if="flag"></div>
        </div>
        <div class="right_text" :class="{color_pink: !flag}" @click="fn(false);">我的笔记
          <div class="red_line" v-if="!flag"></div>
        </div>
      </div>
    </com-top-title>
    ...
    <div class="banner">
      <div v-show="flag">
        <div v-if="all_note_data && all_note_data.length">
          <div class="sign">
            <div class="centerr" v-show="userWrite==1">报名后才能写笔记哟</div>
            <div class="center2" v-show="userWrite==0" @click="write_note">
              <span>写我的听课笔记</span><span><img src="//9i.dvmama.com/free/2017/08/01/icon/write.png" alt=""></span>
            </div>
          </div>
            ...
            <div class="note_border" v-for="(item,index) in all_note_data" @click="show_all(item)">
              <div class="note_container note_container1">
                <div class="note_title">
                  <div class="header_img" :style="{'background-image': 'url(' + item.headImg + ')','background-repeat':'no-repeat','background-position':'center center','background-size': '100% 100%' ,'background-size': 'cover'}">
                ...
                <p class="note_text note_text1" :class="{ a : show_list[index]==2}"
                ...
                <div class="imgs">
                  <div v-for="(v,index) in item.imgList">
                    ...
                    <div class="img_div"
                         :style="{'background-image': 'url(' + v + ')','background-repeat':'no-repeat','background-position':'center center','background-size': '100% 100%' ,'background-size': 'cover'}"
                         @click.stop='showImg(index,item.imgList, v)'></div>
                  </div>
                </div>

                <div class="note_share" v-if="isapp">
                  <div class="count"><span v-if="item.shareNum!=0">{{ item.shareNum }}</span></div>
                  <div class="icon" @click.stop='share(item)'><img
                    src="http://9i.dvmama.com/free/2017/02/07/material-share.png" alt=""></div>
                </div>
        ...
        <div v-if='dataFlag1'>
          <div class="no_class">
            <div class="no_class_img">
              <img src="//9i.dvmama.com/free/2017/08/01/no_class.png" alt="">
            </div>
          ...
          <div class="note" id='myNote'>
            <div class="note_border" v-for="(item2 , index) in my_note_data" @click="show_all(item2)">
              <div class="note_container note_container2">
                <div class="note_title">
                  <div class="header_img" :style="{'background-image': 'url(' + note_header + ')','background-repeat':'no-repeat','background-position':'center center','background-size': '100% 100%' ,'background-size': 'cover'}">
                ...
                <p class="note_text note_text2" :class="{ a : show_list2[index]==2}"
                   v-html="item2.content.replace(/\n/g,'<br/>')"></p>
                ...
                <div class="imgs">
                  <div v-for="(m,index) in item2.imgList">
                    ...
                    <div class="img_div"
                         :style="{'background-image': 'url(' + m + ')','background-repeat':'no-repeat','background-position':'center center','background-size': '100% 100%' ,'background-size': 'cover'}"
                         @click.stop='showImg(index,item2.imgList, m)'></div>
                  </div>
                </div>
                ...
                <div class="end">
                  <div class="note_share" v-show="item2.status==1 && isapp">
                    ...
                    <div class="icon" @click.stop='share(item2)'><img src="http://9i.dvmama.com/free/2017/02/07/material-share.png" alt=""></div>
                  </div>
    ...
    <!--<div v-show="mask_close && !isapp">
      ...
      <div class="btn-1" @click="close">知道啦

        <div class="all_mask">
          <div class="white_space">我的笔记</div>
          <div class="mask_img"><img src="//9i.dvmama.com/free/2017/08/10/myNote.png" alt=""></div>
        </div>
      </div>
    </div>-->

    <div v-if='noLogin && !flag' class='noApply'>
  ...
  export default{
    ...
    methods: {
      ...
      wxShare(){
        ...
        // shareInfo.imgUrl = 'http://9i.dvmama.com/shop_logo/5/80_80_1426690299.jpg'
      ...
      showImg(i, imgList, img){
        if (this.isapp) {
          ...
          alert(window.wx.previewImage + '123')
        }
      },
      myNote: function () {
        if (this.getStaus() == 0) {
...
//            dialog.alert('code:' + result.code + ';msg:' + result.data.msg)
      ...
      init_star: function (score) {
        if (score == 1) {
          return "//9i.dvmama.com/free/2017/05/09/star_1.png"
        } else if (score == 2) {
          return "//9i.dvmama.com/free/2017/05/09/star_2.png"
        } else if (score == 3) {
          return "//9i.dvmama.com/free/2017/05/09/star_3.png"
        } else if (score == 4) {
          return "//9i.dvmama.com/free/2017/05/09/star_4.png"
        } else if (score == 5) {
          return "//9i.dvmama.com/free/2017/05/09/star_5.png"
        }
      },
      fn: function (flag) {
        var _this = this;
