...
new Vue({
  ...
  components: {
    ...
    'com-act-subscribe': require('../vue/com-act-subscribe.vue').default,
    'com-act-lightbrand': require('../vue/lightBrand.vue').default,
    'com-act-assistance': require('../../act_1018_assistance/vue/com-act-assistance.vue').default,
    'com-act-reserve': require('../../act_1018_reserve/vue/com-act-reserve.vue').default,
    'com-act-explosion': require('../../act_1018_main_explosion/vue/com-act-explosion.vue').default,
    'com-act-bouns-rain': require('../../act_1018_bouns_rain/vue/com-act-bouns-rain.vue').default,
    'com-act-iphone8': require('../vue/iphone8.vue').default,
    'com-act-redpacket': require('../vue/redPacket.vue').default,
    'com-act-souvenir': require('../vue/souvenir.vue').default,
    'com-act-luck-draw': require('../../act_1018_luck_draw/vue/com-act-luck-draw.vue').default,
  },
  data() {
    return {
      response: null,
