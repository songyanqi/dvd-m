<style lang="sass" lang="scss" rel="stylesheet/scss">
  ...
  .one-key-share:after {
    ...
    width:14px;
    height:13px;
    background: url(//9i.dvmama.com/free/2018/05/09/share_icon.png) no-repeat center;
  ...
  .cancel-select {
    ...
    height:r(18);
    line-height: r(18);
    background: url(//9i.dvmama.com/free/2018/05/09/select_icon.png) no-repeat right center;
  ...
  .confirm-select {
    ...
    height:r(18);
    line-height: r(18);
    background: url(//9i.dvmama.com/free/2018/05/09/seleced_icon.png) no-repeat right center;
    background-size: r(16.5) r(16.5);
  }
  .cavs-pic {
    width:100%;
  ...
  .close-preview {
    ...
    width:20px;
    height:20px;
    background: url(//9i.dvmama.com/free/2018/05/09/wx_close_icon.png)no-repeat center;
              ...
              <div class="goods-pic">
                ...
                <div class="picList" v-if="materials[i].materialType==2">
                  ...
                  <div class="videoPicBoc">
                    <i class="vidio-icon"><img src="//9i.dvmama.com/free/goodsDetail/record_icon.png" alt=""></i>
