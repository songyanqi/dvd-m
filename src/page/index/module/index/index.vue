<template>
  <div class="index_inner">
    ...
    <!-- 微信邀请弹框 -->
    <!--<wechatinvite v-if="wechatFlag" :wechatdata="wechatdata" @close="wechatFlag = flag;"></wechatinvite>-->
    <new-we-chat-invite v-if="wechatFlag" :wechatdata="wechatdata" @close="wechatFlag = false"></new-we-chat-invite>
    <we-chat-tip v-if="!wechatFlag && wechatTip" :wechatdata="wechatdata"></we-chat-tip>
