...
new Vue({
  ...
  components: {
    ...
    'daily':require("../vue/newDaily.vue").default,
  },
  data() {
    return {
      response: null,
    ...
    getData(){
      ...
      $.ajax({
        ...
        error(error) {
          ...
          this.success(require('../json/newDaily.json'));
          console.warn(`ajax已使用mock数据: url=${this.url}, mock=newDaily.json`);
        }
      });
    },
  },
