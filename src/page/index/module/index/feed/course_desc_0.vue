<template>
    <div class="course_desc_0" :style="styleObject">
        ...
        <div class="class_introduce_tit" :class="{fixStyle1: fixFlag && ua.compareVersion(ua.getDvdAppVersion(), '5.2.0') < 0 ,
                                            fixStyle_5_2_0: fixFlag && ua.compareVersion(ua.getDvdAppVersion(), '5.2.0') >= 0}" v-if='isApp'>
            <div @click="change(1)" class="class_dis">
                <span :class="{ active: class_introduce_left == 1 }">{{courseDescTitle}}</span>
            </div>
            <div @click="change(0)" class="theater_dis">
        ...
        <div v-if="class_introduce_left==1" class="class_intrduce_left">
            <div v-if='courseDescInfo.courseDescImgUri' class='class_intrduce_left_div'>
                <img v-lazy="item.imgUri" v-for='(item,index) in courseDescInfo.courseDescImgUri' class='class_intrduce_left_img'>
            </div>
        ...
        <div v-if="class_introduce_left==0" class="class_introduce_right">
            <div class="class_introduce_con">
                <a>
                    <div class="teacher_tit">
                        <img @click='goTeacher(teacherDescInfo.command.content)' class="img" v-lazy="teacherDescInfo.teacherAvatar" alt="">
                        ...
                        <div class='attention_all' v-if='userId != teacherDescInfo.teacherId'>
                            ...
                            <img class='attention_yes1' v-lazy="'//pic.davdian.com/free/2017/05/25/introduce_btn1.png'" v-if='attention==0' @click='attention_yes'>
            ...
            <div class="class_introduce_con guest_introduce_con" v-for="item in guestList">
                <a>
                    <div class="teacher_tit">
                        <img @click='goTeacher(item.command.content)' class="img" v-lazy="item.avatar" alt="">
                        <div class="teacher_dis">
                        ...
                        <div class='attention_all' v-if='userId != item.teacherId'>
                            ...
                            <img class='attention_yes1' v-lazy="'//pic.davdian.com/free/2017/05/25/introduce_btn1.png'" v-if='item.followStatus==0' @click='attention_yes_guest(item.teacherId)'>
        ...
        <div v-if="class_introduce_left==2">
            <div class='discuss_top'>
                 <img v-if='introduceGuide && guide==2 && userTicket==1' class='introduceGuide1 writeAllSignUp' v-lazy="'//pic.davdian.com/free/2017/08/11/writeAllSignUp.png'">
                 <img v-if='introduceGuide && guide==2 && userTicket==0' class='introduceGuide1 writeAllSignUp' v-lazy="'//pic.davdian.com/free/2017/08/11/writeAllNotSignUp.png'">
                <div class='discuss_top_write' @click='writeNote' v-if='userTicket==1'>
                    写我的听课笔记
                    <img v-lazy="'//pic.davdian.com/free/2017/07/26/write.png'">
                ...
                <div class='discuss_top_alldiscuss' @click='allNote'>
                    全部笔记
                    <!-- <img v-lazy="'//pic.davdian.com/free/2017/07/26/entry.png'"> -->
                </div>
                <i class='icon'></i>
            </div>
            <div class='discuss_container' v-if='notesList.length!=0' :class='{discuss_container_noborder: index == notesList.length-1}' v-for="(item, index) in notesList" @click.stop='show_all(item)'>
                <div class='discuss_title'>
                    <div class='title_img title_all'
                         :style="{'background-image': 'url(' + item.headImg + ')','background-repeat':'no-repeat','background-position':'center center','background-size': '100% 100%' ,'background-size': 'cover'}">
                    ...
                    <img class='title_star title_all' v-if='item.score == 1' v-lazy="'//pic.davdian.com/free/2017/05/09/star_1.png'">
                    <img class='title_star title_all' v-if='item.score == 2' v-lazy="'//pic.davdian.com/free/2017/05/09/star_2.png'">
                    <img class='title_star title_all' v-if='item.score == 3' v-lazy="'//pic.davdian.com/free/2017/05/09/star_3.png'">
                    <img class='title_star title_all' v-if='item.score == 4' v-lazy="'//pic.davdian.com/free/2017/05/09/star_4.png'">
                    <img class='title_star title_all' v-if='item.score == 5' v-lazy="'//pic.davdian.com/free/2017/05/09/star_5.png'">
                </div>
                ...
                <div class='discuss_imgContainer' >
                    <div class='discuss_img' :style="{'background-image': 'url(' + item1 + ')','background-repeat':'no-repeat','background-position':'center center','background-size': '100% 100%' ,'background-size': 'cover'}" v-for="(item1, index) in item.imgList" @click='showImg(index,item.imgList, item1)'>
                      <!--<img v-lazy="item1" alt="">-->
                    </div>
                </div>
                <div class='discuss_share' v-if='isApp'>
                    <div class='discuss_share_container' @click.stop='share(item)' v-if='isApp'>
                        <img v-lazy="'//pic.davdian.com/free/2017/02/07/material-share.png'">
            ...
            <div class='no_discuss' v-if='notesList.length==0'>
                <img v-lazy="'//pic.davdian.com/free/2017/05/10/error_img.png'">
                <p>快来写笔记吧</p>
        ...
        <!--<img v-if='introduceGuide && guide==1' class='introduceGuide lectureNnotesAll' v-lazy="'//pic.davdian.com/free/2017/08/08/lectureNnotesAll.png'">-->
