...
import NewWeChatInvite from './newWeChatInvite.vue';
import WeChatTip from './weChatTip.vue';
...
export default {
            ...
            (function() {
              that.$nextTick(function() {
                if (response.data.checkAdviserInfo.needPop) {
                  ...
                  // 如果没有妈妈顾问信息要弹出则请求判断是否要谈微信群邀请
                  let wechatalert = localStorage.getItem('wechatalert');
                  if (this.contentData.indexPopInfo) {
                    this.wechatdata = this.contentData.indexPopInfo;
                    if (!wechatalert) {
                      if (this.contentData.indexPopInfo.needPop) {
                        localStorage['wechatalert'] = '1';
                        this.wechatFlag = true;
                      }
                    }
                    if (this.wechatdata.showTip && this.wechatdata.showTip == '1') {
                      this.wechatTip = true;
                    }
                  }
                }
  ...
  components: {
    ...
    NewWeChatInvite: NewWeChatInvite,
    WeChatTip: WeChatTip
  },
  created: function() {
    (function(doc, win) {
