...
new Vue({
  el: '.app',
  components: {
    'com-top-title': require('../../../component/com-top-title_growthBox.vue').default,
    'com-to-top-icon': require('dvd-service-com-go-page-top').default,
    "index":require("../vue/musicDetail_intro.vue").default
  },
  data() {
    return {
      response: null,
    ...
    getData(){
      ...
      $.ajax({
        ...
        error(error) {
          ...
          this.success(require('../json/musicDetail_intro.json'));
          console.warn(`ajax已使用mock数据: url=${this.url}, mock=musicDetail_intro.json`);
        }
      });
    },
  },
