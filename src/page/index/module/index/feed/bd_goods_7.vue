    ...
    <div :style="[{ marginTop:data.marginTop + 'px'},styleObject]">
      ...
      <div v-if="ts_tips" class="tipswrap" @click="tipsconfirm">
        <div class="tipsdiv" @click.stop="events">
          <img v-if="isWechart" v-lazy="'//pic.davdian.com/free/2017/06/14/tips2.png'" alt="">
          <img v-else v-lazy="'//pic.davdian.com/free/2017/06/14/tips1.png'" alt="">
  ...
  export default {
    ...
    methods: {
      ...
      imgObject: function (imgSrc) {
        return {
          src: imgSrc || '//9i.dvmama.com/free/2017/06/23/260_260_359b8152fdd76bfc7a4b0679909d59c3.png',
          error: '//9i.dvmama.com/free/2017/06/23/260_260_359b8152fdd76bfc7a4b0679909d59c3.png',
          loading: '//9i.dvmama.com/free/2017/06/23/260_260_359b8152fdd76bfc7a4b0679909d59c3.png'
        }
      },
      events: function () {
