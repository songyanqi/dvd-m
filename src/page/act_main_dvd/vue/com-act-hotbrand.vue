...
<template>
  <div class="com-act-explosion">
    <img class="banner" src="[[static]]/page/act_1111_main/img/act_1111_title_01.png">
    <!-- 场次tab -->
    ...
    <div class="g-goods-wrapper" v-if="list">
      <ul>
        <li v-for="(item, i) in list[screenings[tabIndex]].goodsList" @click="goodsClick(item)" class="goods-item">
        <!-- <li v-for="(item, i) in list[screenings[tabIndex]].goodsList" v-if="i < 3" @click="goodsClick(item.goodsId)" class="goods-item"> -->
          ...
          <img class="item-icon" src="//9i.dvmama.com/free/1111/newo/act_1111_hots.png">
  ...
  export default {
    ...
    data() {
      return {
        list: null,
        tabIndex: 0,
        timer: ['0:00','8:00','10:00','14:00','16:00'],
        screenings: [1510329600,1510358400,1510365600,1510380000,1510387200]
      }
    },
    watch: {
      // 监听response变化
