        ...
        <div class='dvk3_container' :style="styleObject">
               <div class='dvk3_content1'>
                    <a @click.stop="clickAnalysis" :href="data.body.dataList[0].command.content" :position="data.position">
                       <div class='dvk3_img'>
                             <img class="newImage" v-lazy="data.body.dataList[0].courseCover""/>
                       ...
                       <div class='dvk3_detail'>
                            <span class='dvk3_name' v-text='data.body.dataList[0].teacherName'><img v-lazy="'//pic.davdian.com/free/2017/03/06/official.png'" class='dvk3_name_titlepic'></span>
               ...
               <div class='dvk3_content2'>
                   <a @click.stop="clickAnalysis" :href="data.body.dataList[1].command.content" :position="data.position">
                       <div class='dvk3_img'>
                            <img class="newImage" v-lazy="data.body.dataList[1].courseCover""/>
                       ...
                       <div class='dvk3_detail'>
                            <span class='dvk3_name' v-text='data.body.dataList[1].teacherName'><img v-lazy="'//pic.davdian.com/free/2017/03/06/official.png'" class='dvk3_name_titlepic'></span>
...
<style scoped>
    ...
    .dvk3_startTimeLine{
        ...
        text-align: center;
        line-height: 0.24rem;
        background: url('//9i.dvmama.com/free/2017/03/06/bg_line1.png');
