  ...
  <div>
    ...
    <div class="activity_container" v-if='isInisWechatOrAppFlag'>
        ...
        <div class='uptitle'>
          <div class='classifyOne' @click='classIfyAll'>
            <div class="classifyOneTag">
              ...
              <img class='classifyOneTagImg' v-if='!classIfyAllFlag' src="//9i.dvmama.com/free/2017/07/20/arrowdown1.png">
              <img class='classifyOneTagImg' v-if='classIfyAllFlag' src="//9i.dvmama.com/free/2017/07/20/arrowup1.png">
            </div>
          </div>
          <div class='classifyOne' @click='timeSortF'>
            <div class="classifyOneTag">
              <span class='classifyOneTagText'>时间</span>
              <img class='classifyOneTagImg' v-if='timeSort == 2' src="//9i.dvmama.com/free/2017/07/20/arrowdown2.png">
              <img class='classifyOneTagImg' v-if='timeSort == 1' src="//9i.dvmama.com/free/2017/07/20/arrowup2.png">
              <img class='classifyOneTagImg' v-if='timeSort == 0' src="//9i.dvmama.com/free/2017/07/20/arrowno2.png">
            </div>
          </div>
          <div class='classifyOne' @click='pvSortF'>
            <div class="classifyOneTag">
              <span class='classifyOneTagText'>人气</span>
              <img class='classifyOneTagImg' v-if='pvSort==2' src="//9i.dvmama.com/free/2017/07/20/arrowdown3.png">
              <img class='classifyOneTagImg' v-if='pvSort==0' src="//9i.dvmama.com/free/2017/07/20/arrowno3.png">
            </div>
          </div>
        </div>
          ...
          <div class='uptitle2_right'>
            <div class='right_containerAll'>
              <div :class='{divSelect: item.cId == cId}' class='div' v-for='(item, index) in dataList[selectIndex].list' @click='classIfyAll3(item.cId, item.cTitle, dataList[selectIndex].fTitle)'>
                ...
                <img v-if='item.cId == cId' src="//9i.dvmama.com/free/2017/07/20/selectCid.png">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class='noData' v-if='isNoData'>
        <img src="//9i.dvmama.com/free/2017/08/08/noDataClassify.png">
        <p>没找到呦，换个关键词试试吧～</p>
      </div>
  </div>
...
<!--组件定义-->
<script>
  import { getQuery, isInisWechatOrApp } from "../../../common/js/utils.es6";
...
//              dialog.alert('code:' + respone.code+';msg:'+respone.data.msg)
      ...
      wxShare(){
        ...
        shareInfo.imgUrl = 'http://9i.dvmama.com/free/2017/04/07/640_640_c04f341e77963fcbad86a4e42df8bb83.jpg?x-oss-process=image/resize,m_fill,w_100,h_100/quality,Q_90&'
        ...
        api(that.webUrl, obj)
          .then(function(respone){
            ...
            if (respone.code == 0){
              ...
              // 默认选中
              if(that.titleFirst){
                that.dataList.forEach((i,index)=>{
                  if(that.fId == i.fId){
                    console.log(i);
                    that.classIfyAll2(index,i.fId);
                  }
                });
              }
            } else {
//              dialog.alert('code:' + respone.code+';msg:'+respone.data.msg)
      ...
      goSerach(href){
        window.location.href = '/m/new_course_search.html'
      },
      classIfyAll(){
