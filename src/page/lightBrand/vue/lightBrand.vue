<template>
  <div>
    <template v-if="isShow==1">
      <div class="banner">
        <div class="big_img"><img src="//9i.dvmama.com/free/2017/09/09/banner.png" alt=""></div>
          ...
          <div class="list_bottom" v-if="item.hotDay==-1">
            ...
            <template v-if="isCompleted[index]!=1">
              ...
              <div class="list_start">
                <img class="start" src="//9i.dvmama.com/free/2017/09/09/start_icon.png" alt="">
            ...
            <template v-if="isCompleted[index]==1">
              <div class="success">
                <div style="position: absolute;">
                  <img src="//9i.dvmama.com/free/2017/09/09/com.png" alt="">
                </div>
            ...
            <div class="list_end">
              <img class="start2" src="//9i.dvmama.com/free/2017/09/09/end_icon.png" alt="">
            ...
            <div class="list_margin" v-if="isLighted[index]!=1" @click.stop="light(item.bandId,index,item.isCompleted)">
              ...
              <div class="list_button">
                <div class="btn" >
                  <span><img :class="{'animated':animateArr[index]==1,'bounceIn':animateArr[index]==1}" :style="{'transition-duration':'10s'}" src="//9i.dvmama.com/free/2017/09/20/red2.png" alt=""></span>
            ...
            <div class="list_margin" v-if="isLighted[index]==1">
              ...
              <div class="list_button">
                <div class="btn">
                  <span><img :class="{'animated':animateArr[index]==1,'bounceIn':animateArr[index]==1}" :style="{'transition-duration':'10s'}" src="//9i.dvmama.com/free/2017/09/20/new.png" alt=""></span>
    ...
    <div class="error" v-if="isShow==-1 && !isApp">
      <div class="mask"></div>
      <img class="mask_img" src="//9i.dvmama.com/free/2017/09/16/nosale.png" alt="">
      <div class="mask_text">
        <div>活动已结束</div>
        <div>关注更多精彩活动</div>
      </div>
...
<style scoped>
  ...
  .list_end{
    background-image:url("//9i.dvmama.com/free/2017/09/09/bea.png");
  ...
  .button{
    ...
    width: 1.95rem;
    height: 0.4rem;
    background-image: url("//9i.dvmama.com/free/2017/09/16/bg.png");
