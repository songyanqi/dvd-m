      ...
      <div class="hot_goods_index_md">
        <div class="goods_desc">
          <div class="img_left">
            ...
            <img v-if="item.topImageUrl" class="topImageUrl" v-lazy="item.topImageUrl" alt="">
          </div>
          <div class="goods_info_box">
            ...
            <div class="comment_star">
              ...
              <img v-for="item in parseInt((item.rating*100)/20)"
                   v-lazy="'//9i.dvmama.com/free/2017/07/24/%20starSelected.png'" alt="">
            </div>
          </div>
        </div>
        <div v-if="item.comments.content" class="goods_comment">
          ...
          <div class="user_img">
            <img v-lazy="item.comments.avatar" alt="">
          </div>
...
<style scoped>
  ...
  .box_arrow {
    width: 10px;
    height: 5px;
    background: url("//9i.dvmama.com/free/2017/07/24/commentBox_arrow.png");
    background-size: 100%;
    position: absolute;
    top: -4px;
    left: 22px;
