<style>
  ...
  .loadIcon {
    /*background: url("//9i.dvmama.com/free/goodsDetail/loadingS.gif");*/
...
<template>
    <div>
        <div class = "picContVideo">
            ...
            <div v-for = "item of picdetails" class="lazyPic">
                <img :src="item.detailUrl">
            </div>
            <div v-if="addmodulemes&&!isbiggift">
              <!--买过的人还买了-->
              <another-buy :response="addmodulemes" v-if="addmodulemes && addmodulemes.data && addmodulemes.data.goodsList"></another-buy>
            </div>

            <div class = "mt_10" @click = "periodtj" v-if='!isbiggift'>
