...
import tt_com_1 from '../../index/module/index/feed/tt_com_1.vue';
...
const DetailPic = {
    components: {
      ...
      tt_com_1: tt_com_1,
      'another-buy': require('./another_buy.vue').default
    },
    computed:{

    },
    props: ['picdetails','mayyoulikelist','mayyoulikenomore',
            'isapp', 'isprompt','videoobj','goodsid','addmodulemes','isbiggift'],
    data () {
        return {
          goodsList: null,
          no_more:false,
