<template>
  <div>
    <div class="banner">
      <div class="big_img" :style="{'backgroundImage':'url(//9i.dvmama.com/free/2017/09/09/banner.png)'}">
        <!--<img v-lazy="//9i.dvmama.com/free/2017/09/09/banner.png">-->
      </div>
        ...
        <div class="list_bottom" v-if="item.hotDay==-1">
          ...
          <template v-if="isCompleted[index]!=1">
            ...
            <div class="list_start">
              <img class="start" v-lazy="'//9i.dvmama.com/free/2017/09/09/start_icon.png'">
          ...
          <template v-if="isCompleted[index]==1">
            <div class="success">
              <div style="position: absolute;">
                <img v-lazy="'//9i.dvmama.com/free/2017/09/09/com.png'">
              </div>
          ...
          <div class="list_end">
            <img class="start2" v-lazy="'//9i.dvmama.com/free/2017/09/09/end_icon.png'">
          ...
          <div class="list_margin" v-if="lightArr[index]!=1" @click.stop="light(item.bandId,index,item.isCompleted)">
            ...
            <div class="list_button">
              <div class="btn" >
                <span><img :class="{'animated':animateArr[index]==1,'bounceIn':animateArr[index]==1}" :style="{'transition-duration':'10s'}" v-lazy="'//9i.dvmama.com/free/2017/09/20/red2.png'"></span>
          ...
          <div class="list_margin" v-if="lightArr[index]==1">
            ...
            <div class="list_button">
              <div class="btn">
                <span><img :class="{'animated':animateArr[index]==1,'bounceIn':animateArr[index]==1}" :style="{'transition-duration':'10s'}" v-lazy="'//9i.dvmama.com/free/2017/09/20/new.png'"></span>
