...
<template>
    ...
    <img style = "display: none;" src="//9i.dvmama.com/free/ydd1.png">
    <img style = "display: none;" src="//9i.dvmama.com/free/ydd7.png">
    <img style = "display: none;" src="//9i.dvmama.com/free/1022/iphone8_mask_icon.png">
    <div class = "luckTitle">
    ...
    <div class = "luckCont" id="lottery">
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td class="lottery-unit lottery-unit-0"><img src="//9i.dvmama.com/avatar_poster/1018money.png"></td>
          <td class="lottery-unit lottery-unit-1"><img src="//mamaj-oss.oss-cn-beijing.aliyuncs.com/free/1022/iphone8_icon.png"></td>
          <td class="lottery-unit lottery-unit-2"><img src="//9i.dvmama.com/avatar_poster/1018money1.png"></td>
        </tr>
        <tr>
          <td class="lottery-unit lottery-unit-7"><img src="//9i.dvmama.com/avatar_poster/mysterious_icon.png"></td>
          <td @click = "handleClick"><img src="//9i.dvmama.com/avatar_poster/luckbtn.png"></td>
          <td class="lottery-unit lottery-unit-3"><img src="//9i.dvmama.com/avatar_poster/meme_icon.png"></td>
        </tr>
        <tr>
          <td class="lottery-unit lottery-unit-6"><img src="//9i.dvmama.com/avatar_poster/thanks_icon.png"></td>
          <td class="lottery-unit lottery-unit-5"><img src="//9i.dvmama.com/avatar_poster/renxing_icon.png"></td>
          <td class="lottery-unit lottery-unit-4"><img src="//9i.dvmama.com/avatar_poster/god_icon.png"></td>
        </tr>
      </table>
    </div>
    <!-- 活动规则 -->
    ...
    <div @click = "handleMoney" v-show = "isMoney" class = "moneyCont">
      ...
      <img src="//9i.dvmama.com/free/ydd1.png">
    ...
    <div v-show = "isBouns" class = "bounsCont" @click = "handleBouns">
      ...
      <img src="//9i.dvmama.com/free/ydd7.png">
    ...
    <div @click = "handleIphone" class = "iphoneCont" v-show = "isIphone">
      ...
      <img src="//9i.dvmama.com/free/1022/iphone8_mask_icon.png">
      <div class = "iponeNums">
        <p>恭喜你抽中</p>
