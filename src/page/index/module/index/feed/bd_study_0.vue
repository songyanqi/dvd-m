<template>
  <div class="con" @click="go_landing">
    ...
    <!--<div class="big_img">-->
      ...
      <!--<div class="list_line"></div>-->
      <!--<div class="fixed"><div style="color:#333333;font-size: 12px;">更多</div><div class="arrow"><img v-lazy="'//pic.davdian.com/free/2017/08/16/entry.png'" alt=""></div></div>-->
    <!--</div>-->
    <div class="all">
      <div class="list_all" v-for="item in dataList">
        <div class="list">
          ...
          <div class="list_right" v-if="item.isPlay==1">
            <div class="mask_stop" @click.stop="go_play(item.albumId,item.sortNo)" v-if="( item.albumId==albumId && item.sortNo==sortNo && btnStatus==1)"><img v-lazy="'//pic.davdian.com/free/2017/08/28/listSuspend.png'" alt=""></div>
            <div class="mask_play" @click.stop="go_play(item.albumId,item.sortNo)" v-if="!( item.albumId==albumId && item.sortNo==sortNo && btnStatus==1)"><img v-lazy="'//pic.davdian.com/free/2017/08/28/listPlay2.png'" alt=""></div>
            <div class='mask_play loading_play' v-if="item.sortNo==sortNo && item.albumId==albumId && btnStatus==2"><img v-lazy="'//pic.davdian.com/free/2017/08/26/loading.png'" alt=""></div>
            <div class="circle_mask"></div>
            <div><img v-lazy="item.imageUrl" alt=""></div>
          </div>
          <div class="list_right" v-if="item.isPlay==0">
            <div class="disable" @click.stop="stop_info(item.albumId,item.sortNo)"><img v-lazy="'//pic.davdian.com/free/2017/08/16/Group1.png'" alt=""></div>
            <div class="circle_mask"></div>
            <div><img class="gray" v-lazy="item.imageUrl" alt=""></div>
          </div>
        </div>
      </div>
    </div>
