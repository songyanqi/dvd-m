  ...
  <div>
    <div class="list1">
      ...
      <div class="flist" v-for="(item,index) in dataList">
        <div class="list" @click.stop="go_href(item.albumId,item.sortNo,item.command.content)">
          ...
          <div class="right_img" v-if="item.isPlay==1">
            <div class="mask_stop" @click.stop="go_play(item.albumId,item.sortNo)" v-if="(item.sortNo==sortNo && item.albumId==albumId && btnStatus==1)"><img v-lazy="'//9i.dvmama.com/free/2017/08/28/listSuspend.png'" alt=""></div>
            <div class="mask_play" @click.stop="go_play(item.albumId,item.sortNo)" v-if="!(item.sortNo==sortNo && item.albumId==albumId && btnStatus==1)"><img v-lazy="'//9i.dvmama.com/free/2017/08/28/listPlay2.png'" alt=""></div>
            <div class='mask_play loading_play' v-if="item.sortNo==sortNo && item.albumId==albumId && btnStatus==2"><img v-lazy="'//9i.dvmama.com/free/2017/08/26/loading.png'" alt=""></div>
            <div class="circle_mask"></div>
            <div><img v-lazy="item.imageUrl" alt=""></div>
          </div>
          <div class="right_img" v-if="item.isPlay==0">
            <div class="disable" @click.stop="stop_info(item.albumId,item.sortNo)"><img v-lazy="'//9i.dvmama.com/free/2017/08/16/Group1.png'" alt=""></div>
            <div class="circle_mask"></div>
            <div class="a"><img class="gray" v-lazy="item.imageUrl" alt=""></div>
          </div>
        </div>
        <div class="line"></div>
      </div>
...
<script>
  ...
  export default {
    props:['data','albumIds','sortNos','btnStatuss'],
    computed:{
      albumId(){
